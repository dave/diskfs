...
//
// gpt.Table implements the Table interface in github.com/dave/diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/dave/diskfs package,
